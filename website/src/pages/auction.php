...
<div class="container">
    ...
    <div class="row">
        <div class="d-flex p-3 justify-content-left min-vh-25 col-sm">
            <!-- Images carousel -->
            ...
            <div class="col-sm text-left">
                ...
                <div class="row justify-content-start">
                    <button type="button" class="btn btn-danger mx-3 my-1 mh-25 ">2250.00€</button>
                    <button type="button" class="btn btn-danger mx-3 my-1 mh-25 ">2500.00€</button>
                    <button type="button" class="btn btn-danger mx-3 my-1 mh-25 ">2750.00€</button>
                </div>
