    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <div class="d-flex justify-content-end flex-grow w-100">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
          <a class="nav-link text-light" data-toggle="modal" data-target="#moneyModal">{{ Auth::user()->balance }}€</a>
          ...
          <a class="navbar-brand" href="{{ route('profile',['id' => Auth::id()]) }}">
            <img src="{{asset(App\Image::where('user_id',Auth::id())->first()->path)}}" class="rounded-circle" width="35" height="35" alt="">
            </a>
          </li>
