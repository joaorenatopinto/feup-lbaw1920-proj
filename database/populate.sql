    ...
    INSERT INTO "user" (username, "password", "name", email, nif, image_id, description) VALUES ('poncho', 'hash256', 'Gabe Itches', 'gabe.itches@lbaw.fun', '271654321', 1, 'r');
    ...
    INSERT INTO "user" (username, "password", "name", email, nif, image_id, description) VALUES ('aquafeeling', 'hash256', 'Moe Lester', 'mlester98@hotmail.com', '271353268', 3, 'NO');
    ...
    INSERT INTO follows (user_id,category_id) VALUES (1,1);
    INSERT INTO follows (user_id,category_id) VALUES (2,1);
    INSERT INTO follows (user_id,category_id) VALUES (3,2);
    INSERT INTO follows (user_id,category_id) VALUES (4,3);

    INSERT INTO follows_auction (user_id,auction_id) VALUES (1,1);
    INSERT INTO follows_auction (user_id,auction_id) VALUES (1,3);
    INSERT INTO follows_auction (user_id,auction_id) VALUES (2,1);
    INSERT INTO follows_auction (user_id,auction_id) VALUES (3,2);
    INSERT INTO follows_auction (user_id,auction_id) VALUES (4,4);

    INSERT INTO auction_image (auction_id,image_id) VALUES (1,5);
    INSERT INTO auction_image (auction_id,image_id) VALUES (2,6);
    INSERT INTO auction_image (auction_id,image_id) VALUES (3,7);
