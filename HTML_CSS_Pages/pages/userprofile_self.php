    ...
    <div class="row">
      <div class="col">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="auctions-tab" data-toggle="tab" href="#auctions" role="tab" aria-controls="auctions" aria-selected="true">Active Auctions</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="closed-auctions-tab" data-toggle="tab" href="#closed-auctions" role="tab" aria-controls="closed-auctions" aria-selected="false">Closed Auctions</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="money-tab" data-toggle="tab" href="#money" role="tab" aria-controls="money" aria-selected="false">Money Transfers</a>
          </li>
        </ul>
        <div class="tab-content mt-4" id="myTabContent">
            ...
            <div class="card m-3 mx-auto">
              <div class="row no-gutters">
                ...
                <div class="card-body col-md-7 p-3">
                  ...
                  <h3><a href="auction.php" class="btn btn-primary" style="width: 10rem;">GOTO PAGE</a><span class="badge">1337.69€</span></h3>
                </div>
              </div>
            </div>
            <div class="card m-3 mx-auto">
          ...
          <div class="tab-pane fade" id="closed-auctions" role="tabpanel" aria-labelledby="closed-auctions-tab">
            <div class="card m-3 mx-auto">
              <div class="row no-gutters">
                <img class="card-img col-md-5" src="img/Harley-Davidson-FXDR-114_Fernando-M-1.jpg" alt="Card image cap">
                <div class="card-body col-md-7 p-3">
