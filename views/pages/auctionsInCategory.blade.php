            ...
            <div class="card mx-auto m-3 mt-0">
                <div class="row no-gutters">
                    ...
                    <div class="card-body col-md-7 p-3">
                        ...
                        <p class="card-text">2008, 1600cc, 6vel, many extras and in immaculate condition. Recent
                            overhaul and new tires.</p>
                        <p class="card-text">00d 22h 25m 17s left</p>
                        <h3><a href="auction.php" class="btn btn-primary" style="width: 10rem;">BID NOW</a> <span
                                class="badge">2000.43€</span></h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card mx-auto m-3">
                <div class="row no-gutters">
                    ...
                    <div class="card-body col-md-7 p-3">
                        ...
                        <p class="card-text">2015, 1600cc, 7vel, next-level technology advancements and sharp styling
                            updates.</p>
                        <p class="card-text">03d 02h 21m 57s left</p>
                        <h3><a href="auction.php" class="btn btn-primary" style="width: 10rem;">BID NOW</a> <span
                                class="badge">1337.69€</span></h3>
                    </div>
                </div>
            </div>
        </div>
